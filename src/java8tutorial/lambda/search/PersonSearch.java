...
public class PersonSearch
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("\n\n2 - Ansatz \"Architekt\":");
        printPersonsWithinAgeRange(PersonGenerator.getPersons(), new CheckPersonEligibleForSelectiveService());

        System.out.println("\n\n3 - Ansatz \"Anonymer Kryptologe\":");
        printPersonsWithinAgeRange(PersonGenerator.getPersons(), new PersonCriteria()
        {
            @Override
        ...
        /*
         * Warum funktioniert das? PersonCriteria ist ein funktionales Interface. Es besitzt nur genau eine abstrakte
         * Methode. Der Lambda-Ausdruck funktioniert hier ähnlich wie eine anonyme Klasse. Es gibt einen typisierten
         * Parameter (Person p). Der darauf folgende Ausdruck ist ein boolean, passend zum Rückgabewert der Methode
     ...
     * @param criteria
     */
    public static void printPersonsWithinAgeRange(List<Person> roster, PersonCriteria criteria)
    {
        for (Person p : roster)
        {
            if (criteria.test(p))
    ...
    /**
     * Einsatz eines weiteren generischen Interfaces, um einen zweiten Lambda-Ausdruck zu verwenden.
     * 
     * @param roster
     * @param tester
     * @param block
    ...
    /**
     * Einsatz eines weiteren generischen Interfaces, um einen dritten Lambda-Ausdruck zu verwenden.
     * 
     * @param roster
     * @param tester
     * @param mapper
